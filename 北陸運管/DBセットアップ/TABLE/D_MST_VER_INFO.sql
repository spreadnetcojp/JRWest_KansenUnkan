DROP TABLE D_MST_VER_INFO;
CREATE TABLE D_MST_VER_INFO
(
...
ALTER TABLE D_MST_VER_INFO
ADD CONSTRAINT pk_D_MST_VER_INFO PRIMARY KEY ( MODEL_CODE,RAIL_SECTION_CODE,STATION_ORDER_CODE,CORNER_CODE,UNIT_NO,DATA_KIND);

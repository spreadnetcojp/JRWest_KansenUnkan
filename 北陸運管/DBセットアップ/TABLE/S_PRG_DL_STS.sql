DROP TABLE S_PRG_DL_STS;
CREATE TABLE S_PRG_DL_STS
(
...
ALTER TABLE S_PRG_DL_STS
ADD CONSTRAINT pk_S_PRG_DL_STS PRIMARY KEY ( MODEL_CODE,FILE_KBN,DATA_KIND,VERSION,RAIL_SECTION_CODE,STATION_ORDER_CODE,CORNER_CODE,UNIT_NO);

CREATE INDEX idx_S_PRG_DL_STS ON S_PRG_DL_STS(DATA_SUB_KIND);

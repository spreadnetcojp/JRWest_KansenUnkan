DROP TABLE D_PRG_VER_INFO_CUR;
CREATE TABLE D_PRG_VER_INFO_CUR
(
...
ALTER TABLE D_PRG_VER_INFO_CUR
ADD CONSTRAINT pk_D_PRG_VER_INFO_CUR PRIMARY KEY ( MODEL_CODE,RAIL_SECTION_CODE,STATION_ORDER_CODE,CORNER_CODE,UNIT_NO,ELEMENT_ID);

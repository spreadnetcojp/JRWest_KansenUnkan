DROP TABLE S_MST_LIST_HEADLINE;
CREATE TABLE S_MST_LIST_HEADLINE
(
...
ALTER TABLE S_MST_LIST_HEADLINE
ADD CONSTRAINT pk_S_MST_LIST_HEADLINE PRIMARY KEY ( MODEL_CODE,DATA_KIND,DATA_SUB_KIND,DATA_VERSION,LIST_VERSION);

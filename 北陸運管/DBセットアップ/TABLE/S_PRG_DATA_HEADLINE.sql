DROP TABLE S_PRG_DATA_HEADLINE;
CREATE TABLE S_PRG_DATA_HEADLINE
(
    ...
    RUNNABLE_DATE varchar(8)
);

ALTER TABLE S_PRG_DATA_HEADLINE
ADD CONSTRAINT pk_S_PRG_DATA_HEADLINE PRIMARY KEY ( MODEL_CODE,DATA_KIND,DATA_SUB_KIND,DATA_VERSION);

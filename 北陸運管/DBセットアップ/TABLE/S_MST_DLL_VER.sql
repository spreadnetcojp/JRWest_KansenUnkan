DROP TABLE S_MST_DLL_VER;
CREATE TABLE S_MST_DLL_VER
(
...
ALTER TABLE S_MST_DLL_VER
ADD CONSTRAINT pk_S_MST_DLL_VER PRIMARY KEY ( MODEL_CODE,DATA_KIND,DATA_SUB_KIND,RAIL_SECTION_CODE,STATION_ORDER_CODE,CORNER_CODE,UNIT_NO);

DROP TABLE S_PRG_DLL_STS;
CREATE TABLE S_PRG_DLL_STS
(
...
ALTER TABLE S_PRG_DLL_STS
ADD CONSTRAINT pk_S_PRG_DLL_STS PRIMARY KEY ( MODEL_CODE,FILE_KBN,DATA_KIND,DATA_SUB_KIND,DATA_VERSION,VERSION,RAIL_SECTION_CODE,STATION_ORDER_CODE,CORNER_CODE,UNIT_NO);

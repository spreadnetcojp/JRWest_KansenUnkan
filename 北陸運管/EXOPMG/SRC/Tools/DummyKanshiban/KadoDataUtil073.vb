...
Public Class KadoDataUtil073
    ...
    Private Shared ReadOnly oFields As XlsField()() = { _
        New XlsField() { _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計042 改(Ａ)IC処理件数（IC複合券）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計043 改(Ａ)IC処理件数（ICFREX複合券、ICFREX定期券）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計044 改(Ａ)IC処理件数（MS）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計045 改(Ａ)IC処理件数（ICFREX複合券、定期券＋MS）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計046 改(Ａ)判定NG件数（IC複合券）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計047 改(Ａ)判定NG件数（ICFREX複合券、ICFREX定期券）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計048 改(Ａ)判定NG件数（MS）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計049 改(Ａ)判定NG件数（ICFREX複合券、定期券＋MS）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計066 改(Ａ)有効組合せ判定NG（在来線）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計067 改(Ａ)有効組合せ判定NG（東海道新幹線）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計075 改(Ａ)無効券判定NG（自駅入場済判定）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計087 改(Ａ)有効組合せ判定ＮＧ（乗車券･特急券区間比較判定）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計088 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計089 改(Ａ)有効組合せ判定ＮＧ（接続判定）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計090 改(Ａ)有効組合せ判定NG（当駅迄の特急券不足）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計094 改(Ａ)有効組合せ判定NG（定期券・特急券区間比較判定）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計095 改(Ａ)不正判定NG（同一駅短時間出入場異常）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計096 改(Ａ)不正判定ＮＧ（複数回使用異常）（再投入）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計097 改(Ａ)ｶｰﾄﾞ使用不可ﾋﾞｯﾄ書込件数（ﾈｶﾞﾁｪｯｸ時）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計098 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計099 改(Ａ)通信未了（読み取り）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計100 改(Ａ)ICｶｰﾄﾞ書込み処理異常", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計167 改(Ａ)通信未了（書き込み）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計168 改(Ａ)通信未了放棄（読み取り）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計169 改(Ａ)通信未了放棄(書き込み）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計170 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計171 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計172 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計173 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計199 改(Ａ)書込み未了によるﾘｶﾊﾞﾘｰ処理件数", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計240 集(Ａ)IC処理件数（IC複合券）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計241 集(Ａ)IC処理件数（ICFREX複合券、ICFREX定期券）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計244 集(Ａ)IC処理件数（MS）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計245 集(Ａ)IC処理件数（ICFREX複合券、定期券＋MS）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計246 集(Ａ)判定NG件数（IC複合券）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計247 集(Ａ)判定NG件数（ICFREX複合券、ICFREX定期券）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計248 集(Ａ)判定NG件数（MS）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計249 集(Ａ)判定NG件数（ICFREX複合券、定期券＋MS）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計266 集(Ａ)組合せ判定ＮＧ（前途放棄確認）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計267 集(Ａ)不正判定ＮＧ（同一駅短時間入出場異常）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計273 集(Ａ)不正判定ＮＧ（入出場時間異常）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計282 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計283 集(Ａ)有効組合せ判定ＮＧ（６の字乗車券）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計290 集(Ａ)有効組合せ判定ＮＧ（定期券･特急券区間比較判定）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計291 集(Ａ)有効組合せ判定ＮＧ（併用判定）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計292 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計293 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計296 集(Ａ)不正判定ＮＧ（複数回使用異常）（再投入）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計297 集(Ａ)ｶｰﾄﾞ使用不可ﾋﾞｯﾄ書込件数（ﾈｶﾞﾁｪｯｸ時）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計298 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計299 集(Ａ)通信未了（読み取り）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計300 集(Ａ)ICｶｰﾄﾞ書込み処理異常", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計367 集(Ａ)通信未了（書き込み）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計368 集(Ａ)通信未了放棄（読み取り）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計369 集(Ａ)通信未了放棄(書き込み）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計399 集(Ａ)書込み未了によるﾘｶﾊﾞﾘｰ処理件数", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計404 （空き）", Nothing, XlsByteOrder.LittleEndian), _
        ...
        New XlsField() { _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計024 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計028 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計037 改(Ａ)ICR/W異常検知回数", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計041 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計045 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計046 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計059 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計060 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計061 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計062 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計063 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計064 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計065 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計068 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計079 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計080 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計081 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計082 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計083 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計084 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計085 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計086 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計097 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計098 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計099 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計100 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計128 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計129 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計130 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計138 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計154 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計155 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計224 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計228 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計237 集(Ａ)ICR/W異常検知回数", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計242 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計243 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計244 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計245 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計246 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計247 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計248 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計249 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計250 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計251 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計252 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計253 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計256 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計257 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計258 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計259 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計260 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計261 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計262 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計274 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計275 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計276 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計277 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計278 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計279 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計280 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計281 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計282 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計292 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計293 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計294 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計295 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計296 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計297 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計298 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計299 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計300 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            ...
            New XlsField(8*4, "D", 1, " "c, "集計328 （空き）", Nothing, XlsByteOrder.LittleEndian), _
            New XlsField(8*4, "D", 1, " "c, "集計329 （空き）", Nothing, XlsByteOrder.LittleEndian), _

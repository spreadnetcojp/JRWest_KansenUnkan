...
#Region "定数"
    ...
    Private Shared ReadOnly oFileNameRegx As New Regex("^[0-9]{8}_[0-9]{9}_(S|R)_(Telegram|ActvXllF|PasvXllF)_[0-9]+\.DAT$", RegexOptions.IgnoreCase Or RegexOptions.CultureInvariant Or RegexOptions.Compiled)
    ...
    Private Const transKindLenInFileName As Integer = 8
    Private Const dateLenInFileName As Integer = 8  'YYYYMMDD部分のみの文字数（過去日データ退避の実装用）
    Private Const branchNumPosInFileName As Integer = 30
#End Region
...
#Region "メソッド"
    ...
    'NOTE: sDestDirPathが示すディレクトリに特定種別のファイルを作成するのは特定プロセスの特定スレッドのみとする。
    Public Shared Function Gen(ByVal sDestDirPath As String, ByVal timestamp As DateTime, ByVal direction As String, ByVal transKind As String) As String
        ...
        Debug.Assert(transKind.Equals("Telegram") OrElse transKind.Equals("ActvXllF") OrElse transKind.Equals("PasvXllF"))

...
Public Class RiyoDataForm
    ...
    Private Function CreateInitialValue(ByVal oField As XlsField) As String
        Select Case oField.MetaName
            ...
            Case "基本ヘッダー バージョン"
                Return "01"
            Case "通路方向"
                Return RiyoDataUtil.CreatePassDirectionValue(ManagerForm.UiState.Machines(MonitorMachineId).TermMachines(TermMachineId).LatchConf, 0)
            Case Else
        ...
        For i As Integer = 0 To RiyoDataUtil.Fields.Length - 1
            ...
            Select Case RiyoDataUtil.Fields(i).MetaType
                ...
                Case "DiscountKind"
                    ...
                    oCell.ReadOnly = False
                Case "TicketValidity"
                    oCombo.DataSource = Config.TicketValidityItems
                    oCell.ReadOnly = False
    ...
    Private Sub OrgStaReplaceButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OrgStaReplaceButton.Click
        ...
        ReplaceStationIfNeeded("券読取情報 １枚目情報 区間 発駅", sStation)
        ReplaceStationIfNeeded("券読取情報 ２枚目情報 区間 発駅", sStation)
        ReplaceStationIfNeeded("券読取情報 ３枚目情報 区間 発駅", sStation)
        ReplaceStationIfNeeded("券読取情報 ４枚目情報 区間 発駅", sStation)
    ...
    Private Sub DstStaReplaceButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DstStaReplaceButton.Click
        ...
        ReplaceStationIfNeeded("券読取情報 １枚目情報 区間 着駅", sStation)
        ReplaceStationIfNeeded("券読取情報 ２枚目情報 区間 着駅", sStation)
        ReplaceStationIfNeeded("券読取情報 ３枚目情報 区間 着駅", sStation)
        ReplaceStationIfNeeded("券読取情報 ４枚目情報 区間 着駅", sStation)
    ...
    Private Sub EntStaReplaceButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EntStaReplaceButton.Click
        ...
        ReplaceStationIfNeeded("入場駅情報 乗車券 入場駅", sStation)

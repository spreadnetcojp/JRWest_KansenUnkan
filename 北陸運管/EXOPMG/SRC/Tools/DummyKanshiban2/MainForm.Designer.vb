...
Partial Class MainForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.DataGridView2 = New JR.ExOpmg.DummyKanshiban2.XlsDataGridView()
    ...
    Friend WithEvents DataGridView2 As JR.ExOpmg.DummyKanshiban2.XlsDataGridView

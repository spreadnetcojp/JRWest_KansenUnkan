...
Public Class MainForm
    ...
    Public Function StoreRandRiyoData(ByVal sMonitorMachineId As String) As Boolean
        ...
        'NOTE: 20秒あたり最大34人（平均17人）が1台の窓処を通る想定である。
        ...
        Try
            Using oOutputStream As New FileStream(sFilePath, FileMode.Append, FileAccess.Write)
                For i As Integer = 1 To recCount
                    ...
                    RiyoDataUtil.SetFieldValueToBytes("基本ヘッダー バージョン", "02", oBytes)  'TODO: これでよいのか確認。

                    RiyoDataUtil.SetFieldValueToBytes("通過方向", Rand.Next(1, 3).ToString("D2"), oBytes)
                    RiyoDataUtil.SetFieldValueToBytes("ラッチ形態", oTermEntries(termIndex).Value.LatchConf.ToString("X2"), oBytes)
                    ...
                    'TODO: 基本ヘッダー駅コード（通過方向により入場駅または出場駅）や判定結果と整合させたい。
                    'TODO: 他の項目も設定する。
                    ...
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 １枚目情報 乗車券区間 発駅", GetRandStation(), oBytes)
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 １枚目情報 乗車券区間 着駅", GetRandStation(), oBytes)
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 １枚目情報 特急券区間 発駅", GetRandStation(), oBytes)
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 １枚目情報 特急券区間 着駅", GetRandStation(), oBytes)
                    ...
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 １枚目情報 当駅有効券ビット", Rand.Next(0, 2).ToString(), oBytes)

                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ２枚目情報 乗車券区間 発駅", GetRandStation(), oBytes)
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ２枚目情報 乗車券区間 着駅", GetRandStation(), oBytes)
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ２枚目情報 特急券区間 発駅", GetRandStation(), oBytes)
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ２枚目情報 特急券区間 着駅", GetRandStation(), oBytes)
                    ...
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ２枚目情報 当駅有効券ビット", Rand.Next(0, 2).ToString(), oBytes)

                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ３枚目情報 乗車券区間 発駅", GetRandStation(), oBytes)
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ３枚目情報 乗車券区間 着駅", GetRandStation(), oBytes)
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ３枚目情報 特急券区間 発駅", GetRandStation(), oBytes)
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ３枚目情報 特急券区間 着駅", GetRandStation(), oBytes)
                    ...
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ３枚目情報 当駅有効券ビット", Rand.Next(0, 2).ToString(), oBytes)

                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ４枚目情報 乗車券区間 発駅", GetRandStation(), oBytes)
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ４枚目情報 乗車券区間 着駅", GetRandStation(), oBytes)
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ４枚目情報 特急券区間 発駅", GetRandStation(), oBytes)
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ４枚目情報 特急券区間 着駅", GetRandStation(), oBytes)
                    ...
                    RiyoDataUtil.SetFieldValueToBytes("券読取情報 ４枚目情報 当駅有効券ビット", Rand.Next(0, 2).ToString(), oBytes)

...
Partial Class RiyoDataForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.RiyoDataGridView = New JR.ExOpmg.DummyMadosho2.XlsDataGridView()
    ...
    Friend WithEvents RiyoDataGridView As JR.ExOpmg.DummyMadosho2.XlsDataGridView

...
#Region "コンストラクタ"
    Public Sub New()
        MyBase.New(&H08, EkConstants.ModelCodeMadosho, DbConstants.PortPurposeRiyoData, False)
        ...
        Me.sCdtClientModelName = Lexis.CdtMadosho.Gen()
        Me.sCdtPortName = Lexis.CdtRiyoDataPort.Gen()
    End Sub
#End Region
...
#Region "メソッド"
    ...
    Protected Overrides Sub ProcOnAccept(ByVal oSocket As Socket)
        ...
        If oRcvTeleg.ObjCode <> EkComStartReqTelegram.FormalObjCodeInMadosho Then

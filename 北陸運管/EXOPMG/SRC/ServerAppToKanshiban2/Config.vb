...
Public Class Config
    ...
    'プロセス別キーに対するプレフィックス
    Private Const MODEL_NAME As String = "Kanshiban2"

    ''' <summary>INIファイルから運管サーバの対監視盤利用データ通信プロセスに必須の全設定値を取り込む。</summary>
    Public Shared Sub Init(ByVal sIniFilePath As String)
        ...
        Try
            ...
            Dim oTempDic As Dictionary(Of String, String) = GetFileSectionAsDictionary("GateRiyoData")

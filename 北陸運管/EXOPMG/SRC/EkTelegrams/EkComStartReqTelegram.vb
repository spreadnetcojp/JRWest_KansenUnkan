...
''' 接続初期化REQ電文。
''' </summary>
Public Class EkComStartReqTelegram
    Inherits EkReqTelegram

#Region "定数"
    Public Const FormalObjCodeInKanshiban As Byte = &HAB
    Public Const FormalObjCodeInOpClient As Byte = &HAB
    Public Const FormalObjCodeInMadosho As Byte = &HCB
...
#Region "メソッド"
    ...
    'ACK電文を生成するメソッド
    Public Function CreateAckTelegram() As EkComStartAckTelegram
        Return New EkComStartAckTelegram(Gene, ObjCode)
    End Function

    '渡された電文の型をACK電文の型に変換するメソッド
    Protected Overrides Function ParseAsIAck(ByVal oReplyTeleg As ITelegram) As ITelegram
        Return New EkComStartAckTelegram(oReplyTeleg)
    End Function

    '渡された電文の型をACK電文の型に変換するメソッド
    Public Function ParseAsAck(ByVal oReplyTeleg As ITelegram) As EkComStartAckTelegram
        Return New EkComStartAckTelegram(oReplyTeleg)
    End Function
#End Region

...
''' <summary>
''' 最も基本的なクライアント主体ULLのACK電文。
''' </summary>
Public Class EkClientDrivenUllAckTelegram
    Inherits EkTelegram
...
#Region "プロパティ"
    ...
    Public Property ContinueCode() As ContinueCode
        Get
            ...
            If EkClientDrivenUllReqTelegram.oContinueCodeTable.TryGetValue(RawBytes(GetRawPos(ContinueCodePos)), code) = False Then
        ...
        Set(ByVal code As ContinueCode)
            RawBytes(GetRawPos(ContinueCodePos)) = EkClientDrivenUllReqTelegram.oRawContinueCodeTable(code)
        End Set
    End Property

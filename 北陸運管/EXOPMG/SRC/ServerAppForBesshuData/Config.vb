...
Public Class Config
    ...
    Private Const DATA_NAME As String = "BesshuData"

    ''' <summary>INIファイルから運管サーバの別集札データ登録プロセスに必須の全設定値を取り込む。</summary>
    Public Shared Sub Init(ByVal sIniFilePath As String)
        RecServerAppBaseInit(sIniFilePath, DATA_NAME)

        Try
            ReadFileElem(PATH_SECTION, "BesshuDataFormatFilePath")

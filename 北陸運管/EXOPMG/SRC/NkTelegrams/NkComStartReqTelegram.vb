...
''' 開局要求電文。
''' </summary>
Public Class NkComStartReqTelegram
...
#Region "コンストラクタ"
    Public Sub New(ByVal seqCode As NkSeqCode, ByVal replyLimitTicks As Integer)
        MyBase.New(seqCode, NkCmdCode.ComStartReq, ObjLen, replyLimitTicks)
    End Sub
...
#Region "メソッド"
    ...
    'ACK電文を生成するメソッド
    Public Function CreateAckTelegram() As NkComStartAckTelegram
        Return New NkComStartAckTelegram(SeqCode)
    End Function
    ...
    Public Overrides Function IsValidAck(ByVal iReplyTeleg As ITelegram) As Boolean
        ...
        If oReplyTeleg.CmdCode <> NkCmdCode.ComStartAck Then Return False
    ...
    Protected Overrides Function ParseAsIAck(ByVal oReplyTeleg As ITelegram) As ITelegram
        Return New NkComStartAckTelegram(oReplyTeleg)
    End Function

    '渡された電文の型をACK電文の型に変換するメソッド
    Public Function ParseAsAck(ByVal oReplyTeleg As ITelegram) As NkComStartAckTelegram
        Return New NkComStartAckTelegram(oReplyTeleg)
    End Function
#End Region
